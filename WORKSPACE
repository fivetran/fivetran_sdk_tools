...
http_archive(
    ...
    urls = [
        "https://artifact-cache.it-fivetran.com/repository/github/protocolbuffers/protobuf/archive/refs/tags/v25.1.tar.gz",
...
http_archive(
    ...
    repo_mapping = {
        "@com_google_protobuf_javalite": "@com_google_protobuf",
    },
    sha256 = "4264560a4d0ed6053c88e202ba161e87edd4eb7ac4ea88d070b9b822041a3f2d",
    strip_prefix = "grpc-java-1.61.1",
    urls = [
        "https://artifact-cache.it-fivetran.com/repository/github/grpc/grpc-java/archive/refs/tags/v1.61.1.tar.gz",
        "https://github.com/grpc/grpc-java/archive/refs/tags/v1.61.1.tar.gz",
    ],
)
...
maven_install(
    ...
    artifacts = [
        ...
        "org.junit.jupiter:junit-jupiter-migrationsupport:5.10.1",
